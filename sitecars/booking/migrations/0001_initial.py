    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_trip', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='autho', to=settings.AUTH_USER_MODEL)),
                ('cat', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='bestcar.category', verbose_name='категория')),
                ('name_companion', models.ForeignKey(default='default', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Имя пассажира')),
            ],
            options={
